            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                <p className="text-dark-600 dark:text-dark-300 leading-relaxed">
                  Hello! I'm Kusum Kharayat, a passionate Full Stack Developer and UI/UX Designer based in India. With a strong foundation in computer science and a keen eye for design, I specialize in building digital experiences that are both functional and visually appealing.
                </p>
                <br></br>
                <p className="text-dark-600 dark:text-dark-300 leading-relaxed">
                  My journey in tech began with a simple curiosity about how things work on the web. Since then, I’ve been dedicated to mastering modern technologies and frameworks—from React and Node.js to intuitive design systems. I believe in writing clean, maintainable code and designing with the end user in mind.
                </p>
                <br></br>
                <p className="text-dark-600 dark:text-dark-300 leading-relaxed">
                  When I’m not coding, you’ll find me exploring new technologies, contributing to open-source projects, sketching creative ideas, or diving into books. Reading not only helps me unwind but also broadens my perspective and inspires fresh ideas for my work.
                </p>
              </div>
